...
const Dropdown = () => {
  ...
  return (
    <div className="relative inline-block text-left">
      <div>
        <button
          className="inline-flex items-center justify-between w-64 px-4 py-2 text-sm font-medium text-white bg-gray-900 rounded-sm focus:outline-none focus:ring focus:ring-gray-200"
          id="dropdown-button"
          aria-haspopup="listbox"
          aria-expanded={isDropdownOpen}
          onClick={toggleDropdown}
        >
          <div className='flex flex-nowrap flex-col text-left'>
            <span className='text-xs text-gray-400 font-semibold'>xxx Construction</span>
            <span className='text-xs text-gray-300 font-bold'>Select a Project</span>
          </div>
          <svg
